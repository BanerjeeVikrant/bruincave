...
class JuniorViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let postString = "type=3&o=0&user="+usernameSet+"&group=0";
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = postTableView.dequeueReusableCell(withIdentifier: "juniorcell") as! JuniorTableViewCell
    ...
    func loadMore() {
        ...
        offset = offset + 5
        let postString = "type=3&o="+String(offset)+"&user="+usernameSet+"&group=0"
