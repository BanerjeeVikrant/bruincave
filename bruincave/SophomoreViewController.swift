...
class SophomoreViewController: UIViewController, UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        let postString = "type=2&o=0&user="+usernameSet+"&group=0";
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = postTableView.dequeueReusableCell(withIdentifier: "sophomorecell") as! SophomoreTableViewCell
    ...
    func loadMore() {
        ...
        offset = offset + 5
        let postString = "type=2&o="+String(offset)+"&user="+usernameSet+"&group=0"
