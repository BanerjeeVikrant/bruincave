//
//  AnonymousPostCommentsViewController.swift
//  bruincave
//
...
class AnonymousPostCommentsViewController: UIViewController {
    ...
    @IBAction func sendAnonymousComment(_ sender: Any) {
        ...
        let myUrl = URL(string: "http://www.bruincave.com/m/andriod/postanoncomments.php");
        ...
        let postString = "id="+commentsidSet+"&u="+username+"&c="+txt;
