...
class FavoritesViewController: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = postTableView.dequeueReusableCell(withIdentifier: "favoritescell") as! FavoritesTableViewCell
    ...
    func loadMore() {
        ...
        offset = offset + 5
        let postString = "type=0&o="+String(offset)+"&user="+usernameSet+"&group=0"
